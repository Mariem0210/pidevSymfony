 ...
 */
final class Version20250407171205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE produit CHANGE id_produit id_produit INT NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE produit CHANGE id_produit id_produit INT AUTO_INCREMENT NOT NULL
        SQL);
    }
}
